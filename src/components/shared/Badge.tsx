...
const RUST = '#b65433'
const RUST_DEEP = '#8f381f'
const PINE = '#17403b'
const PINE_SOFT = '#6e8a83'
const AMBER = '#C07B2C'
const GOLD = '#B88A3A'
const SLATE = '#5d6471'
const INK = '#1b2230'
...
const MAP: Record<BadgeVariant, { fg: string; bg: string; dot?: string; label?: string; pulse?: boolean }> = {
  ...
  umbrella:            { fg: '#6E5620', bg: 'rgba(184, 138, 58, 0.16)',dot: GOLD, label: 'UMBRELLA' },

  active:              { fg: PINE,      bg: 'rgba(23, 64, 59, 0.10)',  dot: PINE, label: 'ACTIVE' },
  pending_renewal:     { fg: '#7A4D15', bg: 'rgba(192, 123, 44, 0.16)', dot: AMBER, label: 'PENDING RENEWAL' },
  cancelled:           { fg: SLATE,     bg: 'rgba(27, 34, 48, 0.06)',  dot: SLATE, label: 'CANCELLED' },
  lapsed:              { fg: RUST_DEEP, bg: 'rgba(165, 63, 43, 0.14)', dot: '#A53F2B', label: 'LAPSED' },

  current:             { fg: PINE,      bg: 'rgba(23, 64, 59, 0.10)',  dot: PINE, label: 'CURRENT' },
  past_due:            { fg: '#7A4D15', bg: 'rgba(192, 123, 44, 0.20)', dot: AMBER, label: 'PAST DUE', pulse: true },
  ...
  under_investigation: { fg: '#7A4D15', bg: 'rgba(192, 123, 44, 0.16)', dot: AMBER, label: 'UNDER INVESTIGATION' },
  estimate_pending:    { fg: '#7A4D15', bg: 'rgba(192, 123, 44, 0.16)', dot: AMBER, label: 'ESTIMATE PENDING' },
  closed:              { fg: SLATE,     bg: 'rgba(27, 34, 48, 0.06)',  dot: SLATE, label: 'CLOSED' },
  denied:              { fg: RUST_DEEP, bg: 'rgba(165, 63, 43, 0.14)', dot: '#A53F2B', label: 'DENIED' },

  collision:           { fg: RUST_DEEP, bg: 'rgba(165, 63, 43, 0.12)', dot: '#A53F2B', label: 'COLLISION' },
  comprehensive:       { fg: '#7A4D15', bg: 'rgba(192, 123, 44, 0.14)', dot: AMBER, label: 'COMPREHENSIVE' },
  ...
  fire:                { fg: RUST_DEEP, bg: 'rgba(165, 63, 43, 0.16)', dot: '#A53F2B', label: 'FIRE' },
  theft:               { fg: '#473A58', bg: 'rgba(109, 94, 130, 0.16)', dot: PURPLE, label: 'THEFT' },
  liability:           { fg: '#6E5620', bg: 'rgba(184, 138, 58, 0.14)', dot: GOLD, label: 'LIABILITY' },

  completed:           { fg: PINE,      bg: 'rgba(23, 64, 59, 0.10)',  dot: PINE, label: 'COMPLETED' },
  pending:             { fg: '#7A4D15', bg: 'rgba(192, 123, 44, 0.14)', dot: AMBER, label: 'PENDING' },
  failed:              { fg: RUST_DEEP, bg: 'rgba(165, 63, 43, 0.16)', dot: '#A53F2B', label: 'FAILED' },

  owned:               { fg: PINE,      bg: 'rgba(23, 64, 59, 0.08)',  dot: PINE, label: 'OWNED' },
  financed:            { fg: '#7A4D15', bg: 'rgba(192, 123, 44, 0.12)', dot: AMBER, label: 'FINANCED' },
  leased:              { fg: RUST_DEEP, bg: 'rgba(182, 84, 51, 0.10)', dot: RUST, label: 'LEASED' },

  self:                { fg: INK,       bg: 'rgba(27, 34, 48, 0.06)',  label: 'SELF' },
  spouse:              { fg: '#473A58', bg: 'rgba(109, 94, 130, 0.12)', label: 'SPOUSE' },
  child:               { fg: '#6E5620', bg: 'rgba(184, 138, 58, 0.12)', label: 'CHILD' },
